...
projeto feito em scratch para introduzir a lógica de programação com uma linguagem mais visual.
...
~~ você é uma bactéria
~~ tem 30 segundos para comer toda matéria orgânica
~~ movimento aleatório da matéria ( determinado por uma variação de valores entre 1 e 10 nos eixos X e Y )

<img width="489" alt="Exemplo do jogo" src="https://i.ibb.co/y0P9PLs/foto1projeto-Bacteria.png">
